...
- **Neck Template Generator v1.1.7** — bolt-on neck side-profile layout with a three-point draggable transition editor and click-away handles, headplate veneer, flexible measurement entry, SVG export, and portrait tiled 1:1 printing.
